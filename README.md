...
2026-07-28 기준 오프라인 회귀는 100개다. 기존의 추가 근거 원자성·쟁점 계보·저장 세대·workflow-v1 전체 재개 회귀에 더해 Markdown 구조 경계와 UTF-8/BOM/CRLF 재구성, schema 2 팩·프롬프트·저장 무결성, XML escape 적응형 CORE 분할, 팩 축소·불가능 경계, 동일 원문 A/B 계보 분리, A/B 최소 배치 preflight, 실제 과거 형식으로 정제한 schema 1 workflow-v2 모드 2·3 전체 재개 fixture와 대용량 A/B 균형 부분 커버리지 E2E를 포함한다.
